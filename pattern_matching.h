...
#define extractSymbolFromNode(n) ((pm_labeled_edge_t *) dbllist_data(n))->label
#define extractStateFromNode(n) ((pm_labeled_edge_t *) dbllist_data(n))->state
...
struct pm_state
{
	...
	dbllist_t* output;  //list of patterns //malloc list// char*
